-- Drop the existing function first, then recreate with correct return type
DROP FUNCTION IF EXISTS public.create_project_secure(text,text,text,text,text,text);

-- Recreate the function to return complete project record
