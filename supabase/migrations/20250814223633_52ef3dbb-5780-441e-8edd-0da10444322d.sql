...
CREATE INDEX idx_system_analytics_aggregation ON public.system_analytics (aggregation_period);

CREATE INDEX idx_business_metrics_team_id ON public.business_metrics (team_id);
CREATE INDEX idx_business_metrics_project_id ON public.business_metrics (project_id);
...
CREATE INDEX idx_custom_events_team_id ON public.custom_events (team_id);
CREATE INDEX idx_custom_events_project_id ON public.custom_events (project_id);
CREATE INDEX idx_custom_events_user_id ON public.custom_events (user_id);
CREATE INDEX idx_custom_events_name ON public.custom_events (event_name);
CREATE INDEX idx_custom_events_timestamp ON public.custom_events (timestamp);
CREATE INDEX idx_custom_events_entity ON public.custom_events (entity_type, entity_id);

CREATE INDEX idx_analytics_insights_team_id ON public.analytics_insights (team_id);
CREATE INDEX idx_analytics_insights_project_id ON public.analytics_insights (project_id);
CREATE INDEX idx_analytics_insights_type ON public.analytics_insights (insight_type);
CREATE INDEX idx_analytics_insights_category ON public.analytics_insights (insight_category);
CREATE INDEX idx_analytics_insights_impact ON public.analytics_insights (impact_level);
