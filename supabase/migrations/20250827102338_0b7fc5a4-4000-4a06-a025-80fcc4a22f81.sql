...
DROP FUNCTION IF EXISTS public.user_can_access_team_content(uuid, uuid);
...
-- 5. Create validation trigger for data consistency
...
-- 7. Create helper function for team content validation with new signature
