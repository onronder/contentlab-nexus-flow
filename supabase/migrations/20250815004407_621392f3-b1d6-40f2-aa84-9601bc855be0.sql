-- First, check what role_type enum values are allowed
-- Let's see the existing enum definition and use appropriate values
...
-- Drop any existing overly permissive policies that might expose financial data
...
-- Create billing_manager role using management type (based on existing schema pattern)
INSERT INTO public.user_roles (name, slug, description, role_type, hierarchy_level, is_active)
VALUES ('Billing Manager', 'billing_manager', 'Can manage team billing and subscription settings', 'management', 7, true)
...
INSERT INTO public.audit_logs (
  ...
  jsonb_build_object(
    ...
    'affected_data', jsonb_array_get_elements('["subscription_tier", "billing_cycle", "usage_limits", "payment_method_info", "billing_address", "tax_info"]'),
