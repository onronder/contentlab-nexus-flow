-- Create test data with valid workflow status values
WITH project_info AS (
  SELECT '1ccc475a-2fc5-4a11-8e24-191f3d36b06c'::uuid as project_id
),
user_info AS (
  SELECT 'a0e68a9e-8d1e-418c-8e2b-7b2a8c5d6f4e'::uuid as user_id
),
inserted_content AS (
  ...
  FROM project_info, user_info, (VALUES
      ...
      ('Customer Success Case Study - TechCorp Implementation', 'Detailed case study showcasing 40% efficiency improvement and ROI analysis from TechCorp platform implementation.', 'document', 'published', 2345678, 'application/pdf', 'content-files/case-study-techcorp-implementation.pdf', 'content-thumbnails/case-study-techcorp-implementation-thumb.jpg', '{"pages": 12, "customer": "TechCorp", "industry": "SaaS", "results": {"efficiency_improvement": "40%", "cost_savings": "$120k", "time_to_value": "6 weeks"}, "implementation_timeline": "3 months"}', 'published', now() - interval '12 days', now() - interval '5 days'),
...
-- Insert analytics data and tags
