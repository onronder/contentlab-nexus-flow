  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-elegant focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-primary-foreground hover:opacity-90 shadow-glow hover:shadow-elegant hover:scale-105 border border-primary/20",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-elegant hover:shadow-glow",
        premium: "bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-glow hover:shadow-elegant hover:scale-105",
      },
      size: {
